    ...
    <footer className='flex bg-[#E6F1FF] gap-[315px] px-[116px] py-5' >
      <div className='flex gap-[130px]'>
        <div>
          ...
          <br />
          <p><EnvironmentOutlined />  Jalan Soreang, Kota Bandung</p>
          <p><MailOutlined />  Toko@gmail.com</p>
        ...
        <div>
          ...
          <div className='flex gap-3'>
            <a href="#" target="_blank" rel="noopener noreferrer">
              <img className='w-[25px]' src="./logo/ig.png" alt="Instagram" />
            </a>
            <a href="#" target="_blank" rel="noopener noreferrer">
              <img className='w-[25px]' src="./logo/wa.png" alt="Whatsapp" />
            </a>
            <a href="#" target="_blank" rel="noopener noreferrer">
              <img className='w-[25px]' src="./logo/twt.png" alt="Twitter" />
            </a>
          </div>
        </div>
      </div>
